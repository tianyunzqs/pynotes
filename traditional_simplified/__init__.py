...
# @Author      : tianyunzqs
# @Description : fork from https://github.com/skydark/nstools/blob/master/zhtools/langconv.py
...
if __name__ == '__main__':
    # run()
    print(simplified2traditional('中华人民共和国'))
    print(traditional2simplified('中華人民共和國'))
